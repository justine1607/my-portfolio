      ...
      <div className="card-container1 animate--slow slideInRight">
        <div className='card1'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">HTML is the standard markup language for creating web pages and web applications.</p>
        ...
        <div className='card2'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">CSS is a style sheet language used for describing the look and formatting of a document written in HTML.</p>
        ...
        <div className='card3'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">JavaScript is a high-level, interpreted programming language that is widely used for building interactive web pages.</p>
    ...
    <div className="card-container2 animate--slow slideInRight">
        <div className='card4'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">React is a free and open-source front-end JavaScript library for building user interfaces based on components.</p>
        ...
        <div className='card5'>
          ...
          <div className="card-body">
            ...
            <a href="https://en.wikipedia.org/wiki/Bootstrap_(front-end_framework)" className="button">Learn More</a>
          </div>
        </div>
        ...
        <div className='card6'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">Node.js is a cross-platform, open-source JavaScript runtime environment that can run on Windows, Linux, Unix, macOS, and more.</p>
    ...
    <div className="card-container3 animate--slow slideInRight">
        <div className='card7'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">Git is a version control system. Git helps you keep track of code changes.Git is used to collaborate on code.</p>
        ...
        <div className='card8'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">MongoDB is a document database with the scalability and flexibility with the querying and indexing that you need.</p>
        ...
        <div className='card9'>
          ...
          <div className="card-body">
            ...
            <p className="card-text">Tailwind CSS is an open source CSS framework. The main feature of this library is that, unlike other CSS frameworks like Bootstrap.</p>
